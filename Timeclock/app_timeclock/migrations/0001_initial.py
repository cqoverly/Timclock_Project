...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_timeclock_timestamp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('stamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('in_out', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal(u'app_timeclock', ['Timestamp'])


    def backwards(self, orm):
        # Deleting model 'Timestamp'
        db.delete_table(u'app_timeclock_timestamp')
